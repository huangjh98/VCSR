...
annotations = {
    ...
    #'era_precomp': ['train_caps.txt', 'test_caps.txt'],
    'drone_precomp': ['train_caps.txt', 'test_caps.txt'],
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', default='drone_precomp',
                        help='{coco,f30k}')
